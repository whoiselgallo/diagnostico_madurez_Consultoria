...
with st.sidebar:
    ...
    st.info("Responde las preguntas en el panel principal 👉")

# --- FUNCIONES DE AYUDA ---
def obtener_puntaje(opcion):
    # Extrae el número del string " (1) Texto..."
...
# Botón de simulación de envío
if st.button("Generar Reporte PDF (Simulado)"):
    st.toast("El reporte se ha generado y enviado a tu correo.")